...
function registrar_bloque_post_relacionados() {
    register_block_type( 'mi-tema/post-relacionados', array(
        'render_callback' => 'renderizar_post_relacionados',
    ) );
}
add_action( 'init', 'registrar_bloque_post_relacionados' );
...
function renderizar_post_relacionados( $attributes ) {
    ...
    $query_args = array(
        ...
        'posts_per_page' => 3, // Puedes ajustar la cantidad de posts relacionados
    );
    ...
    return 'No hay posts relacionados.';
}
